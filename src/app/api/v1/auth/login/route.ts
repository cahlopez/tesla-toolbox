 ...
 *     description: Sends credentials to Tesla Factory API to validate user and return a JWT token.
...
export async function POST(request: Request) {
  try {
    ...
    // Use mock authentication instead of Tesla Factory API
